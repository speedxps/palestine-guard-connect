      ...
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <h1 className="text-lg sm:text-2xl md:text-3xl font-bold text-primary truncate">سجل المشتبهين والمتهمين</h1>
          </div>
                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    {citizen.photo_url ? (
                      <img
                        ...
                        className="w-12 h-12 sm:w-16 sm:h-16 rounded-full object-cover border-2 border-red-200 flex-shrink-0"
                      />
                    ) : (
                      <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-red-100 dark:bg-red-900 flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-1 sm:gap-2 text-xs">
                        ...
                        <span className="bg-red-100 dark:bg-red-900 px-2 py-1 rounded text-red-700 dark:text-red-300 whitespace-nowrap">
                          🔍 قيد التحقيق
                        </span>
                      </div>
                    </div>
