...
export type UserRole = 'admin' | 'traffic_police' | 'cid' | 'special_police' | 'cybercrime' | 'judicial_police' | 'officer' | 'user' | 'traffic_manager' | 'cid_manager' | 'special_manager' | 'cybercrime_manager';
